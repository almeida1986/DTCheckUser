url='https://github.com/almeida1986/DTCheckUser.git'
checkuser='https://github.com/almeida1986/DTCheckUser/raw/master/executable/checkuser'
...
function console_menu() {
    ...
    echo -n 'CHECKUSER DTUNNEL MENU v1 - '
    if is_installed; then
